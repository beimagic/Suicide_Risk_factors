...
###### basic lists
if (k==1){
  m.ls2=as.data.frame(fread(paste0(path_med,"Med_proteins.csv")))
  mean_2 ="mpr"
}else if (k==2){
  m.ls2=as.data.frame(fread(paste0(path_med,"Med_bc.csv")))
  mean_2 ="mbc"
}else if (k==3){
  m.ls2=as.data.frame(fread(paste0(path_med,"Med_bb.csv")))
  mean_2 ="mbb"
}else if (k==4){
  m.ls2=as.data.frame(fread(paste0(path_med,"Med_nmr.csv")))
  mean_2="mnmr"
}
colnames(m.ls2)[1] <- "eid"

m.ls1=as.data.frame(fread(paste0(path_med,"Med_gm.csv")))
mean_1 ="mgm"
